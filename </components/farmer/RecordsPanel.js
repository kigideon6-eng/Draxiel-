...
export default function RecordsPanel({ profile }) {
  ...
  async function handleDeleteProject() {
    if (
      !confirm('Delete this project? Entries will keep their data but lose the project link.')
    )
      return;
  ...
  return (
    <div>
      ...
      <p className="text-sm text-charcoal/70 mb-4">
        Track money in and out. Link each entry to a project so it also shows on that farm's
        own page.
      </p>
            ...
            {!showNewProjectInline ? (
              ...
              <div className="space-y-2 mt-2 border-t border-gold/40 pt-2">
                <input
                  ...
                  placeholder="Project name, e.g. Poultry 2026"
