  ...
  return (
    <div>
      ...
      <p className="text-sm text-charcoal/70 mb-4">
        Track money in and out, per project. Upload a receipt for the AI to auto-fill details,
        or type everything in yourself.
      </p>
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        ...
        <div className="card p-3 text-center">
          <p className="text-xs text-charcoal/60">Total earned</p>
            ...
            <div key={entry.id} className="card p-4 flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-charcoal/60 capitalize">
                  {entry.category} {entry.projects?.name ? `· ${entry.projects.name}` : ''}
                </p>
