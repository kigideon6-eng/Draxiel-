    ...
    <div className="min-h-screen bg-cream flex">
      ...
      <div className="flex-1 min-w-0">
        <header className="bg-forest text-white relative overflow-hidden">
          ...
          <div className="relative px-4 sm:px-8 py-5 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <Logo size={34} />
              <div>
                <p className="text-xs uppercase tracking-wide text-gold font-bold">{APP_NAME}</p>
                <h1 className="text-xl font-bold font-display">Welcome, {profile?.full_name}</h1>
                <p className="text-sm text-white/70">{profile?.state}</p>
              </div>
            </div>
